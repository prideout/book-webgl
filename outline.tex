...
\summary{Explains the \texttt{width} and \texttt{height} attributes and how to handle retina displays.}
...
\summary{Explains the \texttt{LINES} primitive and \texttt{drawElements}.}
