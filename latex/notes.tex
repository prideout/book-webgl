...
paperjs looks like a great 2D Canvas API that abstract mouse events, provides 2D vector classes, etc
has metaball and voronoi examples, which is sorta crazy
