...
Each recipe in the book consists of two files: \code{RecipeName.html} and \code{RecipeName.js}.  The latter defines a function \code{main}, which we call from the \code{require} handler to ensure that it executes after all libraries are loaded.
