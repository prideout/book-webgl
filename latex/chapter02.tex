...
In general I try to stay away from mutating API objects in this way, but this seems like it's worth an exception.  See Listing~\ref{lst:GIZA:compileProgram3} to see how \code{compileProgram} is enhanced to automatically graft all uniform locations onto the program object.
