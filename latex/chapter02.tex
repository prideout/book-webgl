...
The implementation of \code{GIZA.compile} is very simple; it simply iterates through the shader specification and delegates to \code{GIZA.compileProgram}; see Listing~\ref{lst:GIZA:compile}.
