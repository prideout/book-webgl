var main1 = function() {
  ...
  var draw = function(currentTime) {
    ...
    gl.uniform4f(program.lightPosition, 0.0, .25, 1, 1);

    gl.uniform3f(program.ambientMaterial, 0.2, 0.1, 0.1);
    gl.uniform4f(program.diffuseMaterial, 1, 209/255, 54/255, 1);
    gl.uniform1f(program.shininess, 200.0);
    gl.uniform3f(program.specularMaterial, 0.2, 0.2, 0.2);
    gl.uniform1f(program.fresnel, 0.0);

    M4.translate(mv, 3 * Math.sin(currentTime / 500), 0, 0);
